...
from nnunetv2.architecetures.Mamba_architectures import UMamba,  SwinUMamba
...
class SwinMambaExperimentPlanner(ExperimentPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'SwinMambaPlans',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
        self.UNet_class = SwinUMamba
        self.UNet_reference_val_3d = 680000000
        self.UNet_reference_val_2d = 135000000
        # self.UNet_blocks_per_stage_encoder = [2,2,9,2]
        # self.UNet_blocks_per_stage_decoder = [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
